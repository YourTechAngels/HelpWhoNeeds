# Generated by Django 3.1.4 on 2021-01-30 20:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('OP', 'Open'), ('AS', 'Assigned'), ('CL', 'Canceled'), ('DN', 'Completed')], default='OP', max_length=5)),
                ...
                ('task_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasktype', to='tasks.tasktype')),
