# Generated by Django 3.1.4 on 2021-01-16 15:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_type_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tasks.tasktype')),
                ('volunteer_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='volunteer_id', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['start_time'],
            },
